...
class Pg2mvt():
    ...
    def tilejson(self, layer, base_url): #TODO prendre le nom de la colonne de geom dans le toml de config
        '''
    ...
    def get_layer_info(self, layer_name, layers_config):
    ...
    def load_tile(self, layer_name, x, y, z, columns, geom_column='geom', extent=4096, buffer=256, clip=True, srid=4326):
        tile = None
