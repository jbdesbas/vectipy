...
class Pg2mvt():
    ...
    def __init__(self, dbparam): #charger aussi le fichier toml et les couches scannée au demarrage
        self.dbparam = dbparam
        self.layers_config = self.scandb()

    def tilejson(self, layer, base_url, schema=DEFAULT_SCHEMA): #TODO prendre le nom de la colonne de geom dans le toml de config
        '''
    ...
    def get_layer_info(self, layer_name, schema = DEFAULT_SCHEMA, default_schema = DEFAULT_SCHEMA ):
    ...
    def load_tile(self, layer_name, x, y, z, columns, schema = DEFAULT_SCHEMA, geom_column='geom', extent=4096, buffer=256, clip=True, limit=2000):
        ...
        xmin, ymin, xmax, ymax = self._tms2bbox(x, y, z)
    ...
    def _tms2bbox(self, x, y, z):
        ...
        '''
        xmin, ymin = self._tms2ll(x, y, z)
        xmax, ymax = self._tms2ll(x + 1, y + 1, z)

        return (xmin, ymin, xmax, ymax)


    def _tms2ll(self, x, y, z):
        '''
...
class Layer(Pg2mvt):
    def __init__(self, layer_name, table_name, dbparam, **kwargs): 
        ...
        self.dbparam = dbparam
        super().__init__(self.dbparam)
    
    def info(self):
        return self.get_layer_info(layer_name = self.table_name )
