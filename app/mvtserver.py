...
class Pg2mvt():
    ...
    def tilejson(self, layer, base_url, schema='public'): #TODO prendre le nom de la colonne de geom dans le toml de config
        '''
    ...
    def get_layer_info(self, layer_name, layers_config, schema = 'public'):
        entry = [e for e in layers_config['layer'] if e.get('name')==layer_name and e.get('schema','public') == schema]
        return entry[0]
    ...
    def load_tile(self, layer_name, x, y, z, columns, schema = 'public', geom_column='geom', extent=4096, buffer=256, clip=True, srid=4326):
        tile = None
